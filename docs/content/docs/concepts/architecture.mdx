...
just nested interfaces. It lives in
[`packages/core/src/ast/query.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/ast/query.ts)
and remains small enough to read end-to-end.
...
SQL string plus a parameter map. It lives in
[`packages/core/src/compiler/query-compiler.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/compiler/query-compiler.ts).
...
The rules in [`inferClickHouseType`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/compiler/query-compiler.ts)
...
- [`packages/core/src/ast/query.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/ast/query.ts)
  &mdash; the AST node definitions
- [`packages/core/src/compiler/query-compiler.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/compiler/query-compiler.ts)
  &mdash; the compiler
- [`packages/core/src/query/select-query-builder.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/query/select-query-builder.ts)
  &mdash; the select builder (most of it is type-overload bodies)
- [`packages/core/src/query/expression-builder.ts`](https://github.com/oorestisime/quarry/blob/main/packages/core/src/query/expression-builder.ts)
  &mdash; the expression builder (mostly typed `eb.fn.*` surface area)
