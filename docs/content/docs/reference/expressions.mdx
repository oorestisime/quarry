...
query expressions. They do not define schema columns, and Quarry does not yet
export `Decimal*` helpers for `defineSchema(...)`.
</Callout>
...
More JSON helpers will be added &mdash; see the
[roadmap](/docs/roadmap#1-more-clickhouse-functions).
